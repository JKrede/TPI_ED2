...
;--------------------------------------------------------------------------------------
; PRUEBA: EL SISTEMA INICIA CON VALOR DE ADC = 100D, EL VALOR DE UMBRAL = 75D EL
;	REGISTRO OPCIONES INICIA CON ALARMA APAGADA
; RESULTADO ESPERADO: NO DEBE ACTIVARSE LA ALARMA, A PESAR DE DISPARARSE LA ALARMA
;--------------------------------------------------------------------------------------
...
INICIO		    ;INICIO PROGRAMA
		    ...
		    MOVLW	    .0
		    MOVWF	    VAL_ADC_D
		    MOVWF	    VAL_ADC_U		; Carga el valor del adc con 100D
		    MOVLW	    .0	           
		    MOVWF	    VAL_UMBRAL_C
		    MOVLW	    .7	           
		    MOVWF	    VAL_UMBRAL_D
		    ...
		    CLRF	    OPCIONES		; Ahora alarma esta desactivada
